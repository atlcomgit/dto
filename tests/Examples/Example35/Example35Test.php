...
final class Example35Test extends TestCase
{
    ...
    public function example(): void
    {
        ...
        $this->assertInstanceOf(Carbon::class, $carbonDto->date1);
        $this->assertInstanceOf(DateTime::class, $carbonDto->date2);
        $this->assertInstanceOf(Carbon::class, $carbonDto->date3);
        $this->assertEquals(Carbon::parse($date1), $carbonDto->date1);
        $this->assertEquals(DateTime::createFromFormat('Y-m-d H:i:s', $date2), $carbonDto->date2);
        $this->assertEquals(Carbon::parse($date3), $carbonDto->date3);
