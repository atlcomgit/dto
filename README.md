...
\
@override @method protected **[onAssigning](#пример-32)**(string $key, mixed $value): void {}\
*Метод-хук выполняется перед изменением значения свойства Dto.*\
\
@override @method protected **[onAssigned](#пример-32)**(string $key): void {}\
...
\
@override @method protected **[onException](#пример-32)**(Throwable $exception): void {}\
